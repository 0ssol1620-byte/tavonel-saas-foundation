-- Provider-native exports can be byte-variant while retaining the same immutable revision.
-- Treat that case as an existing admission, then let the application stop before any
-- compute reservation or object upload. Identity, owner, object key and MIME remain strict.
begin;
