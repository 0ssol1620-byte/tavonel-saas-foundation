...
**상태:** 이 문서가 UI의 **정본(canonical)** 이다 — 단, 진입 페이지 `/`와 `/ko`는 제외한다.
그 두 라우트의 정본은 2026-09-19부터 [`LANDING_V2_2026-09-19.md`](./LANDING_V2_2026-09-19.md)이고,
아래 §2의 8-scene 스크롤은 9-scene Landing V2 구성으로 대체되었다. `/login`과 워크스페이스는
이 문서가 그대로 정본이다.
