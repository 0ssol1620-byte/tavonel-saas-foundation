...
/*
  ...
  `EXPLORE_COPY.countsQualifier` (`lib/explore-story.ts`) rather than here, because its public
  points of use include a client bundle and this module drags the compiler and
