...
export const PROOF_COPY: Record<ProofLocale, ProofStrings> = {
  en: {
    ...
    committedFallback: " The page above is this repository’s committed render of the same source.",
    checkAgain: "Check again",
    bytesVerified: "Source bytes verified in this browser",
    committedVerifying: "Committed render · verifying the source bytes",
  ...
  ko: {
    ...
    committedFallback: " 위 페이지는 같은 원문을 이 저장소가 커밋해 둔 렌더입니다.",
    checkAgain: "다시 확인",
    bytesVerified: "이 브라우저에서 원문 바이트를 검증했습니다",
    committedVerifying: "커밋된 렌더 · 원문 바이트 검증 중",
