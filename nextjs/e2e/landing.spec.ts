...
/*
  The evidence-first landing intentionally exposes seven links into the compiled-world proof.
  Keep the count pinned so an accidental extra door or a silently dropped proof remains visible
  to browser QA, while matching the product contract delivered by this branch.
*/
const EXPLORE_CTA_COUNT = 7;
