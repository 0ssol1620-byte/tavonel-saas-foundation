  ...
  return (
    <div className={styles.root} id="workspace-runs">
      ...
      <section className={styles.theater} aria-labelledby="run-theater-title">
        <div className={styles.head}><div><p>Run detail · no estimated progress</p><h2 id="run-theater-title">Every transition requires an object or receipt.</h2></div><div><span className={styles.state}>{snapshot.nextAction}</span><span className={styles.streamState} role="status">{streamState}</span></div></div>
