...
export default function PrivacyPage() {
  return <PolicyLayout title="Your documents are inputs, not training material." effective={LEGAL_EFFECTIVE_DATE} lastUpdated={LEGAL_LAST_UPDATED} closing={<Link className="btn ghost" href="/contact">Ask a privacy question</Link>} intro={<>This notice explains the production data path for the TAVONEL service. TAVONEL does not sell personal data or use customer document contents to train shared models.</>}>
    ...
    */}
    ...
    <h2>What we collect</h2><p>Account identifiers from Google OAuth; workspace and entitlement metadata; source files you deliberately upload; derived OCR, citation and knowledge artifacts; security and operational logs; billing identifiers supplied by Paddle; and the name, work email, optional company or organization, inquiry type, optional qualification answers, interface language and message you submit through the contact form.</p>
    ...
    */}
    ...
    <p>Where personal data of people in the European Economic Area or the United Kingdom is transferred outside those areas, the transfer is made under the European Commission&apos;s Standard Contractual Clauses, and under the UK International Data Transfer Addendum for a transfer from the United Kingdom. The data processing agreement carries the module and role mapping. Ask <a href="mailto:privacy@tavonel.com">privacy@tavonel.com</a> for a copy.</p>
