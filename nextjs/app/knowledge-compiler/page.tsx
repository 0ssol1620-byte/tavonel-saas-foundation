...
export default function KnowledgeCompilerPage() {
  return <>
    ...
    { title: "When it is not the right tool", collapsed: "open", body: "Cases this product does not serve.", rows: [
