...
const PROCESSORS = [
  ...
  ["Resend", "Transactional inquiry delivery", "Inquiry name, work email, optional company, inquiry type, optional qualification answers, interface language and message", "Global infrastructure; may process outside Korea"],
