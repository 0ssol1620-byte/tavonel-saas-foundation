      ...
      */
      "/compile-jobs": {
        ...
        post: {
          ...
          responses: { "202": { description: "Accepted. Either { code: COMPILE_JOB_ACCEPTED, jobId } or, for a partitioned selection, { code: COMPILE_CORPUS_ACCEPTED, corpusId, batchCount, parts }; Location names whichever resource was created." }, "400": errorResponse, "401": errorResponse, "403": errorResponse, "409": { ...errorResponse, description: "COMPILE_JOB_SLOT_CONFLICT: a part of this corpus is already held by a job over a different document set. Retrying does not clear it." }, "503": errorResponse },
        },
        get: {
